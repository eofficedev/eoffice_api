...
//        $sppdnum = $row_counter->org_start_num + $row_counter->org_counter_id;
        ...
        $data = array(
            ...
            'template_kop_id'=>$this->input->post('template_kop_id'),
    ...
    function get_detail_org($id){
        $this->db->select('A.org_num,A.org_code,A.org_name,A.org_address,A.template_kop_id,A.org_work_telp,A.org_fax,A.org_postal_code,A.org_id,A.org_email,A.org_city,A.org_sub,A.hr_job_num,A.kepala_job_num,B.job_num,B.job_id,B.job_name,B.job_description,B.job_code');
