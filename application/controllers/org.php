...
class Org extends CI_Controller {
    ...
    function index() {
        ...
        $this->data['title'] = 'Data Organisasi';
    ...
    function add_organization() {
        ...
        $this->form_validation->set_rules("org_name", "Nama Organisasi", "trim|required");
        $this->form_validation->set_rules("org_code", "Nama OPD", "trim|required");
        ...
        $this->form_validation->set_rules("org_id", "Kode Organisasi", "callback_cekOrgId|required");
