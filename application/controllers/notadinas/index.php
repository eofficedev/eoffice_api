...
class index extends ci_controller{
    ...
    function move_all_archive(){
      ...
      if($now>$year){
            ...
            //bug fix: no archive folder for certain user. Deleted? this code insert archive folder if not exists
            if(empty($f)){
              $this->folder->emp_num = $this->aktif_user->emp_num;
              $this->folder->folder_name = "archive";
