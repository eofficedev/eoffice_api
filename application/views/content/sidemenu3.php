        ...
        if ($dat->emp_role == 1) {
            ...
            <li class="topmenu"><a href="#" style="height:15px;line-height:15px;">Konfigurasi</a>
                <ul>
                    ...
                    <li><a href="<?php echo base_url(); ?>index.php/notadinas/config">Konfigurasi Nomor Surat Dinas</a></li>
...
<!--                    <li><a href="<?php echo base_url(); ?>index.php/jobs">Konfigurasi Anggaran</a></li>-->
            ...
            if ($dat->emp_role == 3) {
                ...
                <li class="topmenu"><a href="<?php echo base_url() ?>index.php/notadinas/index/" style="height:15px;line-height:15px;">Surat Dinas</a></li>
