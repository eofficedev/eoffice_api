            ...
            <div style="float:left;width:48%">
                <table>
                    <tr>
                        <td>Nama/NIK</td>
                        <td>:</td>
                        <td><?php echo $cuti_creator->emp_firstname." / ".$cuti_creator->emp_id ?></td>
                    </tr>
                    <tr>
                        <td>Jabatan</td>
                        <td>:</td>
            ...
            <div style="float:left;width:40%">
                <table>
                    ...
                    <tr>
                        <td>Atasan</td>
                        <td>:</td>
                        <td><input type="hidden" style="display:none" name="kepala_id" value="<?php echo $cuti->emp_num_kepala ?>"><?php echo $cuti->emp_id_kepala." / ".$cuti->emp_firstname_kepala; ?></td>
                    </tr>
                    <tr>
                        <td>Petugas HR</td>
                        <td>:</td>
                        <td><input type="hidden" style="display:none" name="hr_id" value="<?php echo $cuti->emp_num_hr ?>"><?php echo $cuti->emp_id_hr." / ".$cuti->emp_lastname_hr ?></td>
                    </tr>
                </table>
            </div>
        </div>
