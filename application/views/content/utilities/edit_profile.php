...
<div id="content">
    ...
    <div id="right_content">
        <div id="right_content-img">
            <img width="150" style="margin-left: 70px; margin-top: 20px;" height="150" src="<?php echo base_url(); echo $row2->pic_url ? $row2->pic_url :'css/unknown-prof-pic.png' ?>"/>
        </div>
        <div id="right_content-data" style="text-align: center;">
            <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/utilities/process_change_photo" >
                <input type="file" name="pic" ><br>
                <input type="submit" name="submit" value="Simpan">
                <div class="error-msg"><?php if (isset($upload_error)) {
                   echo $upload_error;
                } ?></div>
            </form>
        </div>
