...
<script type="text/javascript">
    $('document').ready(function() {
        ...
        $('#tgl-kembali-1').change(function() {
            ...
            var day1 = dayp;
            var dayDiff = (day2 - day1) + (monthDiff * 30);
            console.log(tglpergi,tglplg,dayp,monthp,yearp,dayplg,monthplg,yearplg,datepergi,dateplg,yearDiff,y2,y1,monthDiff,day2,day1,dayDiff);
            $('#lama-1').val(dayDiff+1);
        });
        $('.download').button();
    });
