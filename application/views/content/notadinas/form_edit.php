...
<div class="btn-group btn-group-justified">
	 <a class="btn btn-primary" role="button" onclick='submit_edit()'>Submit</a>
	...
	<tbody>
		...
		<tr>
			...
			<td colspan="2"><select class="form-control sel" size="4" id="pemeriksa">
				...
				<a class='btn btn-success' id='btn-show-kepada' onclick="open_dialog_pemeriksa('pemeriksa')">Adress Book</a>
