...
Kode Organisasi</td>
                ...
                <tr>
                    <td>Kota</td>
                    <td> : <input type="text" name="org_city" value="<?php echo $row->org_city; ?>" style="width:350px;"/></td>
                    <td class="error-msg"><?php echo form_error('org_city'); ?></td>
                </tr>
                <tr>
                    <td>Telp</td>
        ...
        <fieldset>
          ...
          <fieldset>
            <legend>Konfigurasi Kop Surat</legend>
            <table>
                <tr>
                    <td>Template Kop Surat</td>
                    <td>: <select name="template_kop_id">
                        <?php foreach ($kop as $key) {
                            $selected = '';
                            if($key->id == $row->template_kop_id)
                                $selected = "selected";
                            ?>
                            <option <?php echo $selected ?> value="<?php echo $key->id ?>"><?php echo $key->name ?></option>
                            <?php                            
                        } ?>
                    </select></td>
                </tr>
