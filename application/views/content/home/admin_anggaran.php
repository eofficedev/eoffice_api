<div id="content">
    ...
    <fieldset>
        ...
        <table style="width:800px;">
            ...
            <tr>
                <td>Kode Anggaran</td>
                <td> : <input style="width: 300px;" type="text" name="kode_anggaran" value="<?php if(isset($anggaran[0])) echo $anggaran[0]->kode_anggaran ?>" /></td>
                <td class="error-msg"><?php echo form_error('app_title'); ?></td>
            </tr>
            <tr>
                <td>Nama Program</td>
                <td> : <input style="width: 300px;" type="text" name="program" value="<?php if(isset($anggaran[0])) echo $anggaran[0]->program_name ?>" /></td>
...
<!--            <tr>
            ...
            <tr>
                ...
                <td> : <input style="width: 300px;" type="text" name="Years" value="<?php if(isset($anggaran[0])) echo $anggaran[0]->years ?>" /></td>
                <td></td>
            </tr>
            <tr>
                <td>Jumlah Anggaran</td>
                <td> : <input style="width: 200px;" type="text" name="Anggaran" value="<?php if(isset($anggaran[0])) echo $anggaran[0]->anggaran ?>" /></td>
                <td></td>
            </tr>
<!--            <tr>
            ...
            <?php if(isset($anggaran[0])){ ?>
            <tr>
                <td>Sisa Anggaran</td>
                <td>: <?php echo $anggaran[0]->amount ?></td>
                <td></td>
            </tr>
            <?php } ?>
            <tr>
