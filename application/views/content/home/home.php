...
<div id="content">
    ...
    <div class="enable-bootstrap" id="content-left" style="padding-left:20px;">
        <div class="row" id="top-left-content">
            <div class="col-md-3">
            ...
            <div class="col-md-7">
                ...
                <a style="margin-bottom: 10px" href="<?php echo base_url(); ?>index.php/site/notif_redirect/id/<?php echo $rownotif->notif_id; ?>">
                    <?php
        ...
        <!-- <div class="row">
            ...
            <div class="col-md-7" id="content-left-2">
                <p><b>SPPD :</b></p>
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                <p><b>Surat Dinas : </b></p>
                <a href="<?php echo base_url(); ?>index.php/notadinas/index/">Page Surat Dinas</a><br/>
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
    ...
    <div id="content-right">
        <div id="content-right-data">
            <p><b>Your Account :</b></p>
             <img width="80" style="margin-left: 105px; margin-top: 20px;" height="80"  src="<?php echo base_url(); echo $row->pic_url ? $row->pic_url :'css/unknown-prof-pic.png' ?>"/>
